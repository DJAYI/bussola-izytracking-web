            ...
            <div class="p-8 max-w-7xl mx-auto w-full">
                <div class="mb-8 flex items-center justify-between">
                    ...
                    @if (isEditing()) {
                        ...
                        <div class="flex gap-2">
                            <a 
                                [routerLink]="['/admin', 'transport-providers']"
...
export class ModifyTransportProviderFormComponent implements OnInit {
    ...
    private loadCompanyDetails(): void {
        this.companyService.getCompanyById('TRANSPORT_PROVIDER', this.companyId).subscribe({
    ...
    protected saveChanges(): void {
        ...
        this.companyService.updateCompanyById('TRANSPORT_PROVIDER', this.companyId, payload).subscribe({
