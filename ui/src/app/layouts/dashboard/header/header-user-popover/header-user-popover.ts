    ...
    <div class="relative flex items-center gap-4">
                ...
                >
                    ...
                    <svg
                        ...
                        stroke-linecap="round"
                        stroke-linejoin="round"
                        class="icon icon-tabler icons-tabler-chevron-down"
                        aria-hidden="true"
                        focusable="false"
                    >
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        ...
                        <ul class="flex flex-col gap-1 [&>li]:flex [&>li]:items-center px-1 py-1">
                            <li>
                                <a
                                    ...
                                    type="button"
                                    role="menuitem"
                                    class="w-full flex items-center text-left gap-2 cursor-pointer px-4 py-1.5 rounded-md hover:bg-red-50 hover:text-red-800 transition-all text-gray-700"
                                    [routerLinkActive]="'bg-red-200 text-red-600 font-semibold [&>svg]:stroke-red-600'"
                                    >
